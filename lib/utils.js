    ...
    if (pesquisavel) {
        ...
        return (
            <div className="relative" ref={containerRef}>
                <div className={`flex items-center rounded-md overflow-hidden transition-colors ${className} ${isOpen ? '!bg-white dark:!bg-darkCard border-brand ring-2 ring-brand/30' : ''} ${disabled ? 'opacity-50 cursor-not-allowed' : ''}`}>
                    <input
                        type="text"
                        disabled={disabled}
                        ...
                        className="w-full min-w-0 bg-transparent outline-none truncate placeholder:text-gray-400 placeholder:font-semibold pl-3.5 pr-2 py-2"
                    />
                    <button
                        type="button"
                        disabled={disabled}
