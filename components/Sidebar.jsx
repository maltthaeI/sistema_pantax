        ...
        <>
            ...
            >
                <div className="h-16 flex items-center gap-3 px-5 border-b border-white/10 shrink-0">
                    <img src="/logo-pantax.webp" alt="Pantax" className="h-8 w-8 shrink-0" />
                    <div className="flex flex-col leading-tight min-w-0">
                        <span className="font-bold text-white truncate">Pantax</span>
                        <span className="text-[10px] text-darkMuted truncate">Apuração Fiscal</span>
                    </div>
                </div>
                    ...
                    {NAV_ITEMS.map(item => {
                        ...
                        return (
                            <button
                                ...
                                className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-[13px] font-semibold transition text-left ${ativo ? 'bg-brand text-white shadow-sm' : 'text-darkText hover:bg-white/5 hover:text-white'}`}
                            >
